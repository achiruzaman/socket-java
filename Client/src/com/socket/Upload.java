...
public class Upload implements Runnable{
    ...
    public void run() {
        try {       
            ...
            ui.txt_pesan_client.append("[Applcation > Me] : File upload complete\n");
            ui.btn_browsefile.setEnabled(true); ui.btn_sendfile.setEnabled(true);
            ui.txt_file.setVisible(true);
